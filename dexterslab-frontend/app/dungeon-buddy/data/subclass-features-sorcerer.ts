...
export const SORCERER_SUBCLASSES: SubclassFeatureSet[] = [
  {
    ...
    features: [
      ...
      { name: 'Draconic Resilience', description: 'Max HP increases by 1 per level. AC equals 13 + DEX when not wearing armor.', level: 1, source: 'Draconic Bloodline', modifiers: [{ type: 'grant_extra_hp', formula: 'class_level' }, { type: 'modify_ac', formula: '13+dex' }] },
