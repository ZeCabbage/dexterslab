...
export const ITEM_DATABASE: Record<string, Partial<InventoryItem>> = {
  ...
  // --- MELEE WEAPONS ---
  item_dagger: { id: "item_dagger", name: "Dagger", type: "weapon", slot: "mainHand", weight: 1, actionCost: "action" },
  item_quarterstaff: { id: "item_quarterstaff", name: "Quarterstaff", type: "weapon", slot: "mainHand", weight: 4, actionCost: "action" },
  item_mace: { id: "item_mace", name: "Mace", type: "weapon", slot: "mainHand", weight: 4, actionCost: "action" },
  item_warhammer: { id: "item_warhammer", name: "Warhammer", type: "weapon", slot: "mainHand", weight: 2, actionCost: "action" },
  item_scimitar: { id: "item_scimitar", name: "Scimitar", type: "weapon", slot: "mainHand", weight: 3, actionCost: "action" },
  item_shortsword: { id: "item_shortsword", name: "Shortsword", type: "weapon", slot: "mainHand", weight: 2, actionCost: "action" },
  item_rapier: { id: "item_rapier", name: "Rapier", type: "weapon", slot: "mainHand", weight: 2, actionCost: "action" },
  item_longsword: { id: "item_longsword", name: "Longsword", type: "weapon", slot: "mainHand", weight: 3, actionCost: "action" },
  item_greatsword: { id: "item_greatsword", name: "Greatsword", type: "weapon", slot: "mainHand", weight: 6, actionCost: "action" },
  item_greataxe: { id: "item_greataxe", name: "Greataxe", type: "weapon", slot: "mainHand", weight: 7, actionCost: "action" },
  item_battleaxe: { id: "item_battleaxe", name: "Battleaxe", type: "weapon", slot: "mainHand", weight: 4, actionCost: "action" },
  item_handaxe: { id: "item_handaxe", name: "Handaxe", type: "weapon", slot: "mainHand", weight: 2, actionCost: "action" },
  item_spear: { id: "item_spear", name: "Spear", type: "weapon", slot: "mainHand", weight: 3, actionCost: "action" },

  // --- RANGED WEAPONS & AMMO ---
  item_light_crossbow: { id: "item_light_crossbow", name: "Light Crossbow", type: "weapon", slot: "mainHand", weight: 5, actionCost: "action" },
  item_shortbow: { id: "item_shortbow", name: "Shortbow", type: "weapon", slot: "mainHand", weight: 2, actionCost: "action" },
  item_longbow: { id: "item_longbow", name: "Longbow", type: "weapon", slot: "mainHand", weight: 2, actionCost: "action" },
  ...
  item_javelin: { id: "item_javelin", name: "Javelin", type: "weapon", weight: 2, actionCost: "action" },
  item_javelin_4: { id: "item_javelin_4", name: "Javelin (4)", type: "weapon", weight: 8, qty: 4, actionCost: "action" },
  item_javelin_5: { id: "item_javelin_5", name: "Javelin (5)", type: "weapon", weight: 10, qty: 5, actionCost: "action" },
  item_dart_10: { id: "item_dart_10", name: "Dart (10)", type: "weapon", weight: 2.5, qty: 10, actionCost: "action" },
