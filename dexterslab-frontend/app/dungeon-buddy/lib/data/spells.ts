...
export const SPELL_DATABASE: Record<string, SpellData> = {
  "spell_acidarrow_02": {
    id: "spell_acidarrow_02", name: "Acid Arrow", level: 2, school: "Evocation",
    castingTime: "1 action", range: "90 feet", components: "V, S, M", duration: "Instantaneous",
    description: `A shimmering green arrow streaks toward a target within range and bursts in a spray of acid. Make a ranged spell attack against the target. On a hit, the target takes 4d4 acid damage immediately and 2d4 acid damage at the end of its next turn. On a miss, the arrow splashes the target with acid for half as much of the initial damage and no damage at the end of its next turn. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, the damage (both initial and later) increases by 1d4 for each slot level above 2nd.`,
    damageType: "acid",
    damage: "4d4 Acid", actionCost: "action", classes: ['Druid', 'Wizard']
  },
  "spell_acidsplash_00": {
    id: "spell_acidsplash_00", name: "Acid Splash", level: 0, school: "Conjuration",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Instantaneous",
    description: `You hurl a bubble of acid. Choose one creature within range, or choose two creatures within range that are within 5 feet of each other. A target must succeed on a dexterity saving throw or take 1d6 acid damage. Higher Levels: This spell's damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6).`,
    damageType: "acid",
    damage: "1d6 Acid", actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_aid_02": {
    id: "spell_aid_02", name: "Aid", level: 2, school: "Abjuration",
    castingTime: "1 action", range: "30 feet", components: "V, S, M", duration: "8 hours",
    description: `Your spell bolsters your allies with toughness and resolve. Choose up to three creatures within range. Each target's hit point maximum and current hit points increase by 5 for the duration. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, a target's hit points increase by an additional 5 for each slot level above 2nd.`,
    actionCost: "action", classes: ['Cleric', 'Paladin']
  },
  "spell_alarm_01": {
    id: "spell_alarm_01", name: "Alarm", level: 1, school: "Abjuration",
    ...
    actionCost: "special", classes: ['Ranger', 'Ritual Caster', 'Wizard']
  },
  "spell_alterself_02": {
    id: "spell_alterself_02", name: "Alter Self", level: 2, school: "Transmutation",
  ...
  "spell_animalfriendship_01": {
    id: "spell_animalfriendship_01", name: "Animal Friendship", level: 1, school: "Enchantment",
    castingTime: "1 action", range: "30 feet", components: "V, S, M", duration: "24 hours",
    description: `This spell lets you convince a beast that you mean it no harm. Choose a beast that you can see within range. It must see and hear you. If the beast's Intelligence is 4 or higher, the spell fails. Otherwise, the beast must succeed on a Wisdom saving throw or be charmed by you for the spell's duration. If you or one of your companions harms the target, the spells ends. Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, you can affect one additional beast for each slot level above 1st.`,
    actionCost: "action", classes: ['Bard', 'Druid', 'Ranger', 'Ritual Caster']
  },
  "spell_animalmessenger_02": {
    id: "spell_animalmessenger_02", name: "Animal Messenger", level: 2, school: "Enchantment",
    castingTime: "1 action", range: "30 feet", components: "V, S, M", duration: "24 hours",
    description: `By means of this spell, you use an animal to deliver a message. Choose a Tiny beast you can see within range, such as a squirrel, a blue jay, or a bat. You specify a location, which you must have visited, and a recipient who matches a general description, such as \"a man or woman dressed in the uniform of the town guard\" or \"a red-haired dwarf wearing a pointed hat.\" You also speak a message of up to twenty-five words. The target beast travels for the duration of the spell toward the specified location, covering about 50 miles per 24 hours for a flying messenger, or 25 miles for other animals.   When the messenger arrives, it delivers your message to the creature that you described, replicating the sound of your voice. The messenger speaks only to a creature matching the description you gave. If the messenger doesn't reach its destination before the spell ends, the message is lost, and the beast makes its way back to where you cast this spell. Higher Levels: If you cast this spell using a spell slot of 3nd level or higher, the duration of the spell increases by 48 hours for each slot level above 2nd.`,
    actionCost: "action", classes: ['Bard', 'Druid', 'Ranger', 'Ritual Caster']
  },
  "spell_animalshapes_08": {
    id: "spell_animalshapes_08", name: "Animal Shapes", level: 8, school: "Transmutation",
  ...
  "spell_antimagicfield_08": {
    id: "spell_antimagicfield_08", name: "Antimagic Field", level: 8, school: "Abjuration",
    ...
    actionCost: "action", classes: ['Cleric', 'Wizard']
  },
  "spell_antipathysympathy_08": {
    id: "spell_antipathysympathy_08", name: "Antipathy/Sympathy", level: 8, school: "Enchantment",
    ...
    actionCost: "special", classes: ['Druid', 'Wizard']
  },
  "spell_arcaneeye_04": {
    id: "spell_arcaneeye_04", name: "Arcane Eye", level: 4, school: "Divination",
  ...
  "spell_arcanesword_07": {
    id: "spell_arcanesword_07", name: "Arcane Sword", level: 7, school: "Evocation",
    ...
    damageType: "force",
    damage: "3d10 Force", actionCost: "action", classes: ['Bard', 'Wizard']
  },
  "spell_arcanistsmagicaura_02": {
    id: "spell_arcanistsmagicaura_02", name: "Arcanist's Magic Aura", level: 2, school: "Illusion",
  ...
  "spell_astralprojection_09": {
    id: "spell_astralprojection_09", name: "Astral Projection", level: 9, school: "Necromancy",
    ...
    actionCost: "special", classes: ['Cleric', 'Warlock', 'Wizard']
  },
  "spell_augury_02": {
    id: "spell_augury_02", name: "Augury", level: 2, school: "Divination",
    ...
    actionCost: "special", classes: ['Cleric', 'Ritual Caster']
  },
  "spell_awaken_05": {
    id: "spell_awaken_05", name: "Awaken", level: 5, school: "Transmutation",
    ...
    actionCost: "special", classes: ['Bard', 'Druid']
  },
  "spell_bane_01": {
    id: "spell_bane_01", name: "Bane", level: 1, school: "Enchantment",
  ...
  "spell_barkskin_02": {
    ...
    actionCost: "action", classes: ['Cleric', 'Druid', 'Ranger']
  },
  "spell_beaconofhope_03": {
    id: "spell_beaconofhope_03", name: "Beacon of Hope", level: 3, school: "Abjuration",
  ...
  "spell_bestowcurse_03": {
    id: "spell_bestowcurse_03", name: "Bestow Curse", level: 3, school: "Necromancy",
    castingTime: "1 action", range: "Touch", components: "V, S", duration: "Concentration, Up to 1 minute",
    description: `You touch a creature, and that creature must succeed on a wisdom saving throw or become cursed for the duration of the spell. When you cast this spell, choose the nature of the curse from the following options:  - Choose one ability score. While cursed, the target has disadvantage on ability checks and saving throws made with that ability score.  - While cursed, the target has disadvantage on attack rolls against you.  - While cursed, the target must make a wisdom saving throw at the start of each of its turns. If it fails, it wastes its action that turn doing nothing.  - While the target is cursed, your attacks and spells deal an extra 1d8 necrotic damage to the target. A remove curse spell ends this effect. At the DM's option, you may choose an alternative curse effect, but it should be no more powerful than those described above. The DM has final say on such a curse's effect. Higher Levels: If you cast this spell using a spell slot of 4th level or higher, the duration is concentration, up to 10 minutes. If you use a spell slot of 5th level or higher, the duration is 8 hours. If you use a spell slot of 7th level or higher, the duration is 24 hours. If you use a 9th level spell slot, the spell lasts until it is dispelled. Using a spell slot of 5th level or higher grants a duration that doesn't require concentration.`,
    damageType: "necrotic",
    damage: "1d8 Necrotic", actionCost: "action", classes: ['Bard', 'Cleric', 'Wizard']
  },
  "spell_blacktentacles_04": {
    id: "spell_blacktentacles_04", name: "Black Tentacles", level: 4, school: "Conjuration",
    ...
    damage: "3d6 Bludgeoning", actionCost: "action", classes: ['Warlock', 'Wizard']
  },
  "spell_bladebarrier_06": {
    id: "spell_bladebarrier_06", name: "Blade Barrier", level: 6, school: "Evocation",
    ...
    damageType: "slashing",
    damage: "6d10 Slashing", actionCost: "action", classes: ['Cleric']
  },
  "spell_bless_01": {
  ...
  "spell_blight_04": {
    id: "spell_blight_04", name: "Blight", level: 4, school: "Necromancy",
    castingTime: "1 action", range: "30 feet", components: "V, S", duration: "Instantaneous",
    description: `Necromantic energy washes over a creature of your choice that you can see within range, draining moisture and vitality from it. The target must make a constitution saving throw. The target takes 8d8 necrotic damage on a failed save, or half as much damage on a successful one. The spell has no effect on undead or constructs. If you target a plant creature or a magical plant, it makes the saving throw with disadvantage, and the spell deals maximum damage to it. If you target a nonmagical plant that isn't a creature, such as a tree or shrub, it doesn't make a saving throw; it simply withers and dies. Higher Levels: When you cast this spell using a spell slot of 5th level of higher, the damage increases by 1d8 for each slot level above 4th.`,
    damageType: "necrotic",
    damage: "8d8 Necrotic", actionCost: "action", classes: ['Druid', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_blindnessdeafness_02": {
    id: "spell_blindnessdeafness_02", name: "Blindness/Deafness", level: 2, school: "Necromancy",
    castingTime: "1 action", range: "30 feet", components: "V", duration: "1 minute",
    description: `You can blind or deafen a foe. Choose one creature that you can see within range to make a constitution saving throw. If it fails, the target is either blinded or deafened (your choice) for the duration. At the end of each of its turns, the target can make a constitution saving throw. On a success, the spell ends. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_blink_03": {
    id: "spell_blink_03", name: "Blink", level: 3, school: "Transmutation",
    ...
    actionCost: "action", classes: ['Cleric', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_blur_02": {
    id: "spell_blur_02", name: "Blur", level: 2, school: "Illusion",
    ...
    actionCost: "action", classes: ['Druid', 'Sorcerer', 'Wizard']
  },
  "spell_brandingsmite_02": {
    id: "spell_brandingsmite_02", name: "Branding Smite", level: 2, school: "Evocation",
    castingTime: "1 bonus action", range: "Self", components: "V", duration: "Concentration, Up to 1 minute",
    description: `The next time you hit a creature with a weapon attack before this spell ends, the weapon gleams with astral radiance as you strike. The attack deals an extra 2d6 radiant damage to the target, which becomes visible if it's invisible, and the target sheds dim light in a 5-­--foot radius and can't become invisible until the spell ends. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, the extra damage increases by 1d6 for each slot level above 2nd.`,
    damageType: "radiant",
    damage: "2d6 Radiant", actionCost: "bonus_action", classes: ['Paladin']
  },
  "spell_burninghands_01": {
    id: "spell_burninghands_01", name: "Burning Hands", level: 1, school: "Evocation",
    castingTime: "1 action", range: "Self", components: "V, S", duration: "Instantaneous",
    ...
    damageType: "fire",
    damage: "3d6 Fire", actionCost: "action", classes: ['Cleric', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_calllightning_03": {
    id: "spell_calllightning_03", name: "Call Lightning", level: 3, school: "Conjuration",
    ...
    damage: "3d10 Lightning", actionCost: "action", classes: ['Cleric', 'Druid']
  },
  "spell_calmemotions_02": {
    id: "spell_calmemotions_02", name: "Calm Emotions", level: 2, school: "Enchantment",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Warlock']
  },
  "spell_chainlightning_06": {
    id: "spell_chainlightning_06", name: "Chain Lightning", level: 6, school: "Evocation",
    ...
    damageType: "lightning",
    damage: "10d8 Lightning", actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_charmperson_01": {
    id: "spell_charmperson_01", name: "Charm Person", level: 1, school: "Enchantment",
  ...
  "spell_chilltouch_00": {
    id: "spell_chilltouch_00", name: "Chill Touch", level: 0, school: "Necromancy",
    castingTime: "1 action", range: "120 feet", components: "V, S", duration: "1 round",
    description: `You create a ghostly, skeletal hand in the space of a creature within range. Make a ranged spell attack against the creature to assail it with the chill of the grave. On a hit, the target takes 1d8 necrotic damage, and it can't regain hit points until the start of your next turn. Until then, the hand clings to the target. If you hit an undead target, it also has disadvantage on attack rolls against you until the end of your next turn. Higher Levels: This spell's damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8), and 17th level (4d8).`,
    damageType: "necrotic",
    damage: "1d8 Necrotic", actionCost: "action", classes: ['Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_circleofdeath_06": {
    id: "spell_circleofdeath_06", name: "Circle of Death", level: 6, school: "Necromancy",
    castingTime: "1 action", range: "150 feet", components: "V, S, M", duration: "Instantaneous",
    description: `A sphere of negative energy ripples out in a 60-foot-radius sphere from a point within range. Each creature in that area must make a constitution saving throw. A target takes 8d6 necrotic damage on a failed save, or half as much damage on a successful one. Higher Levels: When you cast this spell using a spell slot of 7th level or higher, the damage increases by 2d6 for each slot level above 6th.`,
    damageType: "necrotic",
    damage: "8d6 Necrotic", actionCost: "action", classes: ['Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_clairvoyance_03": {
    id: "spell_clairvoyance_03", name: "Clairvoyance", level: 3, school: "Divination",
    ...
    actionCost: "special", classes: ['Bard', 'Cleric', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_clone_08": {
    id: "spell_clone_08", name: "Clone", level: 8, school: "Necromancy",
    ...
    actionCost: "special", classes: ['Wizard']
  },
  "spell_cloudkill_05": {
    id: "spell_cloudkill_05", name: "Cloudkill", level: 5, school: "Conjuration",
    castingTime: "1 action", range: "120 feet", components: "V, S", duration: "Concentration, Up to 10 minutes",
    ...
    damageType: "poison",
    damage: "5d8 Poison", actionCost: "action", classes: ['Druid', 'Sorcerer', 'Wizard']
  },
  "spell_colorspray_01": {
    id: "spell_colorspray_01", name: "Color Spray", level: 1, school: "Illusion",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "1 round",
  ...
  "spell_command_01": {
    id: "spell_command_01", name: "Command", level: 1, school: "Enchantment",
    ...
    actionCost: "action", classes: ['Cleric', 'Paladin', 'Warlock']
  },
  "spell_commune_05": {
    id: "spell_commune_05", name: "Commune", level: 5, school: "Divination",
    ...
    actionCost: "special", classes: ['Cleric', 'Paladin', 'Ritual Caster']
  },
  "spell_communewithnature_05": {
    id: "spell_communewithnature_05", name: "Commune with Nature", level: 5, school: "Divination",
    ...
    actionCost: "special", classes: ['Druid', 'Paladin', 'Ranger', 'Ritual Caster']
  },
  "spell_comprehendlanguages_01": {
    id: "spell_comprehendlanguages_01", name: "Comprehend Languages", level: 1, school: "Divination",
    ...
    actionCost: "action", classes: ['Bard', 'Ritual Caster', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_compulsion_04": {
    id: "spell_compulsion_04", name: "Compulsion", level: 4, school: "Enchantment",
    castingTime: "1 action", range: "30 feet", components: "V, S", duration: "Concentration, Up to 1 minute",
    ...
    actionCost: "action", classes: ['Bard']
  },
  "spell_coneofcold_05": {
    ...
    damageType: "cold",
    damage: "8d8 Cold", actionCost: "action", classes: ['Druid', 'Sorcerer', 'Wizard']
  },
  "spell_confusion_04": {
    id: "spell_confusion_04", name: "Confusion", level: 4, school: "Enchantment",
    castingTime: "1 action", range: "90 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    description: `This spell assaults and twists creatures' minds, spawning delusions and provoking uncontrolled action. Each creature in a 10 foot radius sphere centered on a point you choose within range must succeed on a Wisdom saving throw when you cast this spell or be affected by it.  An affected target can't take reactions and must roll a d10 at the start of each of its turns to determine its behavior for that turn.  | d10 | Behavior | |---|---| | 1 | The creature uses all its movement to move in a random direction. To determine the direction, roll a d8 and assign a direction to each die face. The creature doesn’t take an action this turn. | | 2-6 | The creature doesn’t move or take actions this turn. | | 7-8 | The creature uses its action to make a melee attack against a randomly determined creature within its reach. If there is no creature within its reach, the creature does nothing this turn. | | 9-10 | The creature can act and move normally. |  At the end of each of its turns, an affected target can make a Wisdom saving throw. If it succeeds, this effect ends for that target. Higher Levels: When you cast this spell using a spell slot of 5th level or higher, the radius of the sphere increases by 5 feet for each slot level above 4th.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Sorcerer', 'Wizard']
  },
  "spell_conjureanimals_03": {
    id: "spell_conjureanimals_03", name: "Conjure Animals", level: 3, school: "Conjuration",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Concentration, Up to 1 hour",
    description: `You summon fey spirits that take the form of beasts and appear in unoccupied spaces that you can see within range. Choose one of the following options for what appears:  - One beast of challenge rating 2 or lower  - Two beasts of challenge rating 1 or lower  - Four beasts of challenge rating 1/2 or lower  - Eight beasts of challenge rating 1/4 or lower  - Each beast is also considered fey, and it disappears when it drops to 0 hit points or when the spell ends. The summoned creatures are friendly to you and your companions. Roll initiative for the summoned creatures as a group, which has its own turns. They obey any verbal commands that you issue to them (no action required by you). If you don't issue any commands to them, they defend themselves from hostile creatures, but otherwise take no actions. The DM has the creatures' statistics. Higher Levels: When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear: twice as many with a 5th-level slot, three times as many with a 7th-level, and four times as many with a 9th-level slot.`,
    actionCost: "action", classes: ['Druid', 'Ranger']
  },
  "spell_conjurecelestial_07": {
    id: "spell_conjurecelestial_07", name: "Conjure Celestial", level: 7, school: "Conjuration",
    castingTime: "1 minute", range: "90 feet", components: "V, S", duration: "Concentration, Up to 1 hour",
    description: `You summon a celestial of challenge rating 4 or lower, which appears in an unoccupied space that you can see within range. The celestial disappears when it drops to 0 hit points or when the spell ends. The celestial is friendly to you and your companions for the duration. Roll initiative for the celestial, which has its own turns. It obeys any verbal commands that you issue to it (no action required by you), as long as they don't violate its alignment. If you don't issue any commands to the celestial, it defends itself from hostile creatures but otherwise takes no actions. The DM has the celestial's statistics. Higher Levels: When you cast this spell using a 9th-level spell slot, you summon a celestial of challenge rating 5 or lower.`,
    actionCost: "special", classes: ['Cleric']
  },
  "spell_conjureelemental_05": {
    id: "spell_conjureelemental_05", name: "Conjure Elemental", level: 5, school: "Conjuration",
    castingTime: "1 minute", range: "90 feet", components: "V, S, M", duration: "Concentration, Up to 1 hour",
    description: `You call forth an elemental servant. Choose an area of air, earth, fire, or water that fills a 10-foot cube within range. An elemental of challenge rating 5 or lower appropriate to the area you chose appears in an unoccupied space within 10 feet of it. For example, a fire elemental emerges from a bonfire, and an earth elemental rises up from the ground. The elemental disappears when it drops to 0 hit points or when the spell ends. The elemental is friendly to you and your companions for the duration. Roll initiative for the elemental, which has its own turns. It obeys any verbal commands that you issue to it (no action required by you). If you don't issue any commands to the elemental, it defends itself from hostile creatures but otherwise takes no actions. If your concentration is broken, the elemental doesn't disappear. Instead, you lose control of the elemental, it becomes hostile toward you and your companions, and it might attack. An uncontrolled elemental can't be dismissed by you, and it disappears 1 hour after you summoned it. The DM has the elemental's statistics. Higher Levels: When you cast this spell using a spell slot of 6th level or higher, the challenge rating increases by 1 for each slot level above 5th.`,
    actionCost: "special", classes: ['Druid', 'Wizard']
  },
  "spell_conjurefey_06": {
    id: "spell_conjurefey_06", name: "Conjure Fey", level: 6, school: "Conjuration",
    castingTime: "1 minute", range: "90 feet", components: "V, S", duration: "Concentration, Up to 1 hour",
    description: `You summon a fey creature of challenge rating 6 or lower, or a fey spirit that takes the form of a beast of challenge rating 6 or lower. It appears in an unoccupied space that you can see within range. The fey creature disappears when it drops to 0 hit points or when the spell ends. The fey creature is friendly to you and your companions for the duration. Roll initiative for the creature, which has its own turns. It obeys any verbal commands that you issue to it (no action required by you), as long as they don't violate its alignment. If you don't issue any commands to the fey creature, it defends itself from hostile creatures but otherwise takes no actions. If your concentration is broken, the fey creature doesn't disappear. Instead, you lose control of the fey creature, it becomes hostile toward you and your companions, and it might attack. An uncontrolled fey creature can't be dismissed by you, and it disappears 1 hour after you summoned it. The DM has the fey creature's statistics. Higher Levels: When you cast this spell using a spell slot of 7th level or higher, the challenge rating increases by 1 for each slot level above 6th.`,
    actionCost: "special", classes: ['Druid', 'Warlock']
  },
  "spell_conjureminorelementals_04": {
    id: "spell_conjureminorelementals_04", name: "Conjure Minor Elementals", level: 4, school: "Conjuration",
    castingTime: "1 minute", range: "90 feet", components: "V, S", duration: "Concentration, Up to 1 hour",
  ...
  "spell_conjurewoodlandbeings_04": {
    id: "spell_conjurewoodlandbeings_04", name: "Conjure Woodland Beings", level: 4, school: "Conjuration",
  ...
  "spell_contactotherplane_05": {
    id: "spell_contactotherplane_05", name: "Contact Other Plane", level: 5, school: "Divination",
    ...
    damageType: "psychic",
    damage: "6d6 Psychic", actionCost: "special", classes: ['Ritual Caster', 'Warlock', 'Wizard']
  },
  "spell_contagion_05": {
    id: "spell_contagion_05", name: "Contagion", level: 5, school: "Necromancy",
    ...
    actionCost: "action", classes: ['Cleric', 'Druid']
  },
  "spell_contingency_06": {
    id: "spell_contingency_06", name: "Contingency", level: 6, school: "Evocation",
  ...
  "spell_continualflame_02": {
    id: "spell_continualflame_02", name: "Continual Flame", level: 2, school: "Evocation",
    castingTime: "1 action", range: "Touch", components: "V, S, M", duration: "Until dispelled",
  ...
  "spell_controlwater_04": {
    id: "spell_controlwater_04", name: "Control Water", level: 4, school: "Transmutation",
    ...
    damageType: "bludgeoning",
    damage: "2d8 Bludgeoning", actionCost: "action", classes: ['Cleric', 'Druid', 'Wizard']
  },
  "spell_controlweather_08": {
    id: "spell_controlweather_08", name: "Control Weather", level: 8, school: "Transmutation",
    castingTime: "10 minutes", range: "Self", components: "V, S, M", duration: "Concentration, Up to 8 hours",
    ...
    actionCost: "special", classes: ['Cleric', 'Druid', 'Wizard']
  },
  "spell_counterspell_03": {
    id: "spell_counterspell_03", name: "Counterspell", level: 3, school: "Abjuration",
    castingTime: "1 reaction, which you take when you see a creature within 60 feet of you casting a spell", range: "60 feet", components: "S", duration: "Instantaneous",
    ...
    actionCost: "reaction", classes: ['Paladin', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_createfoodandwater_03": {
    id: "spell_createfoodandwater_03", name: "Create Food and Water", level: 3, school: "Conjuration",
    castingTime: "1 action", range: "30 feet", components: "V, S", duration: "Instantaneous",
    ...
    actionCost: "action", classes: ['Cleric', 'Druid', 'Paladin']
  },
  "spell_createundead_06": {
    id: "spell_createundead_06", name: "Create Undead", level: 6, school: "Necromancy",
    castingTime: "1 minute", range: "10 feet", components: "V, S, M", duration: "Instantaneous",
  ...
  "spell_createordestroywater_01": {
    id: "spell_createordestroywater_01", name: "Create or Destroy Water", level: 1, school: "Transmutation",
  ...
  "spell_creation_05": {
    id: "spell_creation_05", name: "Creation", level: 5, school: "Illusion",
    ...
    actionCost: "special", classes: ['Sorcerer', 'Wizard']
  },
  "spell_curewounds_01": {
    ...
    description: `A creature you touch regains a number of hit points equal to 1d8 + your spellcasting ability modifier. This spell has no effect on undead or constructs. Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, the healing increases by 1d8 for each slot level above 1st.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger']
  },
  "spell_dancinglights_00": {
    id: "spell_dancinglights_00", name: "Dancing Lights", level: 0, school: "Evocation",
    castingTime: "1 action", range: "120 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    description: `You create up to four torch-sized lights within range, making them appear as torches, lanterns, or glowing orbs that hover in the air for the duration. You can also combine the four lights into one glowing vaguely humanoid form of Medium size. Whichever form you choose, each light sheds dim light in a 10-foot radius. As a bonus action on your turn, you can move the lights up to 60 feet to a new spot within range. A light must be within 20 feet of another light created by this spell, and a light winks out if it exceeds the spell's range.`,
    actionCost: "action", classes: ['Bard', 'Sorcerer', 'Wizard']
  },
  "spell_darkness_02": {
    id: "spell_darkness_02", name: "Darkness", level: 2, school: "Evocation",
    ...
    actionCost: "action", classes: ['Druid', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_darkvision_02": {
    id: "spell_darkvision_02", name: "Darkvision", level: 2, school: "Transmutation",
    ...
    actionCost: "action", classes: ['Druid', 'Ranger', 'Sorcerer', 'Wizard']
  },
  "spell_daylight_03": {
    id: "spell_daylight_03", name: "Daylight", level: 3, school: "Evocation",
    ...
    actionCost: "action", classes: ['Cleric', 'Druid', 'Paladin', 'Ranger', 'Sorcerer']
  },
  "spell_deathward_04": {
    id: "spell_deathward_04", name: "Death Ward", level: 4, school: "Abjuration",
  ...
  "spell_delayedblastfireball_07": {
    id: "spell_delayedblastfireball_07", name: "Delayed Blast Fireball", level: 7, school: "Evocation",
    castingTime: "1 action", range: "150 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    description: `A beam of yellow light flashes from your pointing finger, then condenses to linger at a chosen point within range as a glowing bead for the duration. When the spell ends, either because your concentration is broken or because you decide to end it, the bead blossoms with a low roar into an explosion of flame that spreads around corners. Each creature in a 20-foot-radius sphere centered on that point must make a dexterity saving throw. A creature takes fire damage equal to the total accumulated damage on a failed save, or half as much damage on a successful one. The spell's base damage is 12d6. If at the end of your turn the bead has not yet detonated, the damage increases by 1d6. If the glowing bead is touched before the interval has expired, the creature touching it must make a dexterity saving throw. On a failed save, the spell ends immediately, causing the bead to erupt in flame. On a successful save, the creature can throw the bead up to 40 feet. When it strikes a creature or a solid object, the spell ends, and the bead explodes. The fire damages objects in the area and ignites flammable objects that aren't being worn or carried. Higher Levels: When you cast this spell using a spell slot of 8th level or higher, the base damage increases by 1d6 for each slot level above 7th.`,
    actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_demiplane_08": {
    id: "spell_demiplane_08", name: "Demiplane", level: 8, school: "Conjuration",
    ...
    actionCost: "action", classes: ['Warlock', 'Wizard']
  },
  "spell_detectevilandgood_01": {
    id: "spell_detectevilandgood_01", name: "Detect Evil and Good", level: 1, school: "Divination",
  ...
  "spell_detectmagic_01": {
    id: "spell_detectmagic_01", name: "Detect Magic", level: 1, school: "Divination",
    castingTime: "1 action", range: "Self", components: "V, S", duration: "Concentration, Up to 10 minutes",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger', 'Ritual Caster', 'Sorcerer', 'Wizard']
  },
  "spell_detectpoisonanddisease_01": {
    id: "spell_detectpoisonanddisease_01", name: "Detect Poison and Disease", level: 1, school: "Divination",
    ...
    actionCost: "action", classes: ['Cleric', 'Druid', 'Paladin', 'Ranger', 'Ritual Caster']
  },
  "spell_detectthoughts_02": {
    id: "spell_detectthoughts_02", name: "Detect Thoughts", level: 2, school: "Divination",
  ...
  "spell_dimensiondoor_04": {
    ...
    damageType: "force",
    damage: "4d6 Force", actionCost: "action", classes: ['Bard', 'Cleric', 'Paladin', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_disguiseself_01": {
    id: "spell_disguiseself_01", name: "Disguise Self", level: 1, school: "Illusion",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Sorcerer', 'Wizard']
  },
  "spell_disintegrate_06": {
    id: "spell_disintegrate_06", name: "Disintegrate", level: 6, school: "Transmutation",
    castingTime: "1 action", range: "60 feet", components: "V, S, M", duration: "Instantaneous",
    description: `A thin green ray springs from your pointing finger to a target that you can see within range. The target can be a creature, an object, or a creation of magical force, such as the wall created by wall of force. A creature targeted by this spell must make a dexterity saving throw. On a failed save, the target takes 10d6 + 40 force damage. If this damage reduces the target to 0 hit points, it is disintegrated. A disintegrated creature and everything it is wearing and carrying, except magic items, are reduced to a pile of fine gray dust. The creature can be restored to life only by means of a true resurrection or a wish spell. This spell automatically disintegrates a Large or smaller nonmagical object or a creation of magical force. If the target is a Huge or larger object or creation of force, this spell disintegrates a 10-foot-cube portion of it. A magic item is unaffected by this spell. Higher Levels: When you cast this spell using a spell slot of 7th level or higher, the damage increases by 3d6 for each slot level above 6th.`,
    actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_dispelevilandgood_05": {
    id: "spell_dispelevilandgood_05", name: "Dispel Evil and Good", level: 5, school: "Abjuration",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 1 minute",
  ...
  "spell_dispelmagic_03": {
    id: "spell_dispelmagic_03", name: "Dispel Magic", level: 3, school: "Abjuration",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_divination_04": {
    id: "spell_divination_04", name: "Divination", level: 4, school: "Divination",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Instantaneous",
    ...
    actionCost: "action", classes: ['Cleric', 'Druid', 'Ritual Caster']
  },
  "spell_divinefavor_01": {
    id: "spell_divinefavor_01", name: "Divine Favor", level: 1, school: "Evocation",
    ...
    damageType: "radiant",
    damage: "1d4 Radiant", actionCost: "bonus_action", classes: ['Cleric', 'Paladin']
  },
  "spell_divineword_07": {
    id: "spell_divineword_07", name: "Divine Word", level: 7, school: "Evocation",
    castingTime: "1 bonus action", range: "30 feet", components: "V", duration: "Instantaneous",
    description: `You utter a divine word, imbued with the power that shaped the world at the dawn of creation. Choose any number of creatures you can see within range. Each creature that can hear you must make a Charisma saving throw. On a failed save, a creature suffers an effect based on its current hit points:  - 50hp or less: deafened for 1 minute  - 40 hp or less: deafened and blinded for 10 minutes  - 30 hp or less: blinded, deafened and dazed for 1 hour  - 20 hp or less: killed instantly. Regardless of its current hit points, a celestial, an elemental, a fey, or a fiend that fails its save is forced back to its plane of origin (if it isn't there already) and can't return to your current plane for 24 hours by any means short of a wish spell.`,
    actionCost: "bonus_action", classes: ['Cleric']
  },
  "spell_dominatebeast_04": {
    id: "spell_dominatebeast_04", name: "Dominate Beast", level: 4, school: "Enchantment",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Concentration, Up to 1 minute",
    description: `You attempt to beguile a beast that you can see within range. It must succeed on a wisdom saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are fighting it, it has advantage on the saving throw. While the beast is charmed, you have a telepathic link with it as long as the two of you are on the same plane of existence. You can use this telepathic link to issue commands to the creature while you are conscious (no action required), which it does its best to obey. You can specify a simple and general course of action, such as \"Attack that creature,\" \"Run over there,\" or \"Fetch that object.\" If the creature completes the order and doesn't receive further direction from you, it defends and preserves itself to the best of its ability. You can use your action to take total and precise control of the target. Until the end of your next turn, the creature takes only the actions you choose, and doesn't do anything that you don't allow it to do. During this time, you can also cause the creature to use a reaction, but this requires you to use your own reaction as well. Each time the target takes damage, it makes a new wisdom saving throw against the spell. If the saving throw succeeds, the spell ends. Higher Levels: When you cast this spell with a 5th-­level spell slot, the duration is concentration, up to 10 minutes. When you use a 6th-­level spell slot, the duration is concentration, up to 1 hour. When you use a spell slot of 7th level or higher, the duration is concentration, up to 8 hours.`,
    actionCost: "action", classes: ['Cleric', 'Druid', 'Sorcerer', 'Warlock']
  },
  "spell_dominatemonster_08": {
    id: "spell_dominatemonster_08", name: "Dominate Monster", level: 8, school: "Enchantment",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Concentration, Up to 1 hour",
    description: `You attempt to beguile a creature that you can see within range. It must succeed on a wisdom saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are fighting it, it has advantage on the saving throw. While the creature is charmed, you have a telepathic link with it as long as the two of you are on the same plane of existence. You can use this telepathic link to issue commands to the creature while you are conscious (no action required), which it does its best to obey. You can specify a simple and general course of action, such as \"Attack that creature,\" \"Run over there,\" or \"Fetch that object.\" If the creature completes the order and doesn't receive further direction from you, it defends and preserves itself to the best of its ability. You can use your action to take total and precise control of the target. Until the end of your next turn, the creature takes only the actions you choose, and doesn't do anything that you don't allow it to do. During this time, you can also cause the creature to use a reaction, but this requires you to use your own reaction as well. Each time the target takes damage, it makes a new wisdom saving throw against the spell. If the saving throw succeeds, the spell ends. Higher Levels: When you cast this spell with a 9th-level spell slot, the duration is concentration, up to 8 hours.`,
    actionCost: "action", classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_dominateperson_05": {
    id: "spell_dominateperson_05", name: "Dominate Person", level: 5, school: "Enchantment",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Concentration, Up to 1 minute",
    description: `You attempt to beguile a humanoid that you can see within range. It must succeed on a wisdom saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are fighting it, it has advantage on the saving throw. While the target is charmed, you have a telepathic link with it as long as the two of you are on the same plane of existence. You can use this telepathic link to issue commands to the creature while you are conscious (no action required), which it does its best to obey. You can specify a simple and general course of action, such as \"Attack that creature,\" \"Run over there,\" or \"Fetch that object.\" If the creature completes the order and doesn't receive further direction from you, it defends and preserves itself to the best of its ability. You can use your action to take total and precise control of the target. Until the end of your next turn, the creature takes only the actions you choose, and doesn't do anything that you don't allow it to do. During this time you can also cause the creature to use a reaction, but this requires you to use your own reaction as well. Each time the target takes damage, it makes a new wisdom saving throw against the spell. If the saving throw succeeds, the spell ends. Higher Levels: When you cast this spell using a 6th-level spell slot, the duration is concentration, up to 10 minutes. When you use a 7th-level spell slot, the duration is concentration, up to 1 hour. When you use a spell slot of 8th level or higher, the duration is concentration, up to 8 hours.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_dream_05": {
    id: "spell_dream_05", name: "Dream", level: 5, school: "Illusion",
    ...
    damageType: "psychic",
    damage: "3d6 Psychic", actionCost: "special", classes: ['Bard', 'Druid', 'Warlock', 'Wizard']
  },
  "spell_druidcraft_00": {
    id: "spell_druidcraft_00", name: "Druidcraft", level: 0, school: "Transmutation",
    castingTime: "1 action", range: "30 feet", components: "V, S", duration: "Instantaneous",
  ...
  "spell_earthquake_08": {
    id: "spell_earthquake_08", name: "Earthquake", level: 8, school: "Evocation",
    ...
    damageType: "bludgeoning",
    damage: "5d6 Bludgeoning", actionCost: "action", classes: ['Cleric', 'Druid', 'Sorcerer']
  },
  ...
  "spell_enhanceability_02": {
    id: "spell_enhanceability_02", name: "Enhance Ability", level: 2, school: "Transmutation",
    castingTime: "1 action", range: "Touch", components: "V, S, M", duration: "Concentration, Up to 1 hour",
    description: `You touch a creature and bestow upon it a magical enhancement. Choose one of the following effects; the target gains that effect until the spell ends.  **Bear's Endurance.** The target has advantage on constitution checks. It also gains 2d6 temporary hit points, which are lost when the spell ends.  **Bull's Strength.** The target has advantage on strength checks, and his or her carrying capacity doubles.  **Cat's Grace.** The target has advantage on dexterity checks. It also doesn't take damage from falling 20 feet or less if it isn't incapacitated.  **Eagle's Splendor.** The target has advantage on Charisma checks   **Fox's Cunning.** The target has advantage on intelligence checks.  **Owl's Wisdom.** The target has advantage on wisdom checks. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Sorcerer']
  },
  "spell_enlargereduce_02": {
    id: "spell_enlargereduce_02", name: "Enlarge/Reduce", level: 2, school: "Transmutation",
    castingTime: "1 action", range: "30 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    ...
    damage: "1d4 Extra", actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_entangle_01": {
    id: "spell_entangle_01", name: "Entangle", level: 1, school: "Conjuration",
  ...
  "spell_enthrall_02": {
    id: "spell_enthrall_02", name: "Enthrall", level: 2, school: "Enchantment",
    ...
    actionCost: "action", classes: ['Bard', 'Warlock']
  },
  "spell_etherealness_07": {
    id: "spell_etherealness_07", name: "Etherealness", level: 7, school: "Transmutation",
    castingTime: "1 action", range: "Self", components: "V, S", duration: "8 hours",
    description: `You step into the border regions of the Ethereal Plane, in the area where it overlaps with your current plane. You remain in the Border Ethereal for the duration or until you use your action to dismiss the spell. During this time, you can move in any direction. If you move up or down, every foot of movement costs an extra foot. You can see and hear the plane you originated from, but everything there looks gray, and you can't see anything more than 60 feet away. While on the Ethereal Plane, you can only affect and be affected by other creatures on that plane. Creatures that aren't on the Ethereal Plane can't perceive you and can't interact with you, unless a special ability or magic has given them the ability to do so. You ignore all objects and effects that aren't on the Ethereal Plane, allowing you to move through objects you perceive on the plane you originated from. When the spell ends, you immediately return to the plane you originated from in the spot you currently occupy. If you occupy the same spot as a solid object or creature when this happens, you are immediately shunted to the nearest unoccupied space that you can occupy and take force damage equal to twice the number of feet you are moved. This spell has no effect if you cast it while you are on the Ethereal Plane or a plane that doesn't border it, such as one of the Outer Planes. Higher Levels: When you cast this spell using a spell slot of 8th level or higher, you can target up to three willing creatures (including you) for each slot level above 7th. The creatures must be within 10 feet of you when you cast the spell.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_expeditiousretreat_01": {
    id: "spell_expeditiousretreat_01", name: "Expeditious Retreat", level: 1, school: "Transmutation",
  ...
  "spell_eyebite_06": {
    id: "spell_eyebite_06", name: "Eyebite", level: 6, school: "Necromancy",
  ...
  "spell_fabricate_04": {
    id: "spell_fabricate_04", name: "Fabricate", level: 4, school: "Transmutation",
  ...
  "spell_faeriefire_01": {
    id: "spell_faeriefire_01", name: "Faerie Fire", level: 1, school: "Evocation",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Warlock']
  },
  "spell_faithfulhound_04": {
    id: "spell_faithfulhound_04", name: "Faithful Hound", level: 4, school: "Conjuration",
    castingTime: "1 action", range: "30 feet", components: "V, S, M", duration: "8 hours",
    ...
    damageType: "piercing",
    damage: "4d8 Piercing", actionCost: "action", classes: ['Wizard']
  },
  "spell_falselife_01": {
    id: "spell_falselife_01", name: "False Life", level: 1, school: "Necromancy",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "1 hour",
    description: `Bolstering yourself with a necromantic facsimile of life, you gain 1d4 + 4 temporary hit points for the duration. Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, you gain 5 additional temporary hit points for each slot level above 1st.`,
    actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_fear_03": {
    id: "spell_fear_03", name: "Fear", level: 3, school: "Illusion",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 1 minute",
  ...
  "spell_featherfall_01": {
    id: "spell_featherfall_01", name: "Feather Fall", level: 1, school: "Transmutation",
    ...
    actionCost: "reaction", classes: ['Bard', 'Sorcerer', 'Wizard']
  },
  "spell_feeblemind_08": {
    id: "spell_feeblemind_08", name: "Feeblemind", level: 8, school: "Enchantment",
    castingTime: "1 action", range: "150 feet", components: "V, S, M", duration: "Instantaneous",
    ...
    damageType: "psychic",
    damage: "4d6 Psychic", actionCost: "action", classes: ['Bard', 'Druid', 'Warlock', 'Wizard']
  },
  "spell_findfamiliar_01": {
    id: "spell_findfamiliar_01", name: "Find Familiar", level: 1, school: "Conjuration",
  ...
  "spell_findsteed_02": {
    id: "spell_findsteed_02", name: "Find Steed", level: 2, school: "Conjuration",
    ...
    actionCost: "special", classes: ['Paladin']
  },
  "spell_findtraps_02": {
    id: "spell_findtraps_02", name: "Find Traps", level: 2, school: "Divination",
    castingTime: "1 action", range: "120 feet", components: "V, S", duration: "Instantaneous",
  ...
  "spell_findthepath_06": {
    id: "spell_findthepath_06", name: "Find the Path", level: 6, school: "Divination",
    castingTime: "1 minute", range: "Self", components: "V, S, M", duration: "Concentration, Up to 24 hours",
    ...
    actionCost: "special", classes: ['Bard', 'Cleric', 'Druid']
  },
  "spell_fingerofdeath_07": {
    id: "spell_fingerofdeath_07", name: "Finger of Death", level: 7, school: "Necromancy",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Instantaneous",
    ...
    actionCost: "action", classes: ['Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_firebolt_00": {
    id: "spell_firebolt_00", name: "Fire Bolt", level: 0, school: "Evocation",
    castingTime: "1 action", range: "120 feet", components: "V, S", duration: "Instantaneous",
    description: `You hurl a mote of fire at a creature or object within range. Make a ranged spell attack against the target. On a hit, the target takes 1d10 fire damage. A flammable object hit by this spell ignites if it isn't being worn or carried. Higher Levels: This spell's damage increases by 1d10 when you reach 5th level (2d10), 11th level (3d10), and 17th level (4d10).`,
    damageType: "fire",
    damage: "1d10 Fire", actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_fireshield_04": {
    id: "spell_fireshield_04", name: "Fire Shield", level: 4, school: "Evocation",
  ...
  "spell_firestorm_07": {
    id: "spell_firestorm_07", name: "Fire Storm", level: 7, school: "Evocation",
    ...
    damageType: "fire",
    damage: "7d10 Fire", actionCost: "action", classes: ['Cleric', 'Druid', 'Sorcerer']
  },
  "spell_fireball_03": {
  ...
  "spell_flameblade_02": {
    id: "spell_flameblade_02", name: "Flame Blade", level: 2, school: "Evocation",
    castingTime: "1 bonus action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 10 minutes",
    description: `You evoke a fiery blade in your free hand. The blade is similar in size and shape to a scimitar, and it lasts for the duration. If you let go of the blade, it disappears, but you can evoke the blade again as a bonus action. You can use your action to make a melee spell attack with the fiery blade. On a hit, the target takes 3d6 fire damage. The flaming blade sheds bright light in a 10-foot radius and dim light for an additional 10 feet. Higher Levels: When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for every two slot levels above 2nd.`,
    damageType: "fire",
    damage: "3d6 Fire", actionCost: "bonus_action", classes: ['Druid']
  },
  "spell_flamestrike_05": {
    id: "spell_flamestrike_05", name: "Flame Strike", level: 5, school: "Evocation",
    castingTime: "1 action", range: "60 feet", components: "V, S, M", duration: "Instantaneous",
    description: `A vertical column of divine fire roars down from the heavens in a location you specify. Each creature in a 10-foot-radius, 40-foot-high cylinder centered on a point within range must make a dexterity saving throw. A creature takes 4d6 fire damage and 4d6 radiant damage on a failed save, or half as much damage on a successful one. Higher Levels: When you cast this spell using a spell slot of 6th level or higher, the fire damage or the radiant damage (your choice) increases by 1d6 for each slot level above 5th.`,
    damageType: "fire",
    damage: "4d6 Fire", actionCost: "action", classes: ['Cleric', 'Paladin', 'Warlock']
  },
  "spell_flamingsphere_02": {
    id: "spell_flamingsphere_02", name: "Flaming Sphere", level: 2, school: "Conjuration",
    castingTime: "1 action", range: "60 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    description: `A 5-foot-diameter sphere of fire appears in an unoccupied space of your choice within range and lasts for the duration. Any creature that ends its turn within 5 feet of the sphere must make a dexterity saving throw. The creature takes 2d6 fire damage on a failed save, or half as much damage on a successful one. As a bonus action, you can move the sphere up to 30 feet. If you ram the sphere into a creature, that creature must make the saving throw against the sphere's damage, and the sphere stops moving this turn. When you move the sphere, you can direct it over barriers up to 5 feet tall and jump it across pits up to 10 feet wide. The sphere ignites flammable objects not being worn or carried, and it sheds bright light in a 20-foot radius and dim light for an additional 20 feet. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d6 for each slot level above 2nd.`,
    damageType: "fire",
    damage: "2d6 Fire", actionCost: "action", classes: ['Cleric', 'Druid', 'Wizard']
  },
  "spell_fleshtostone_06": {
    id: "spell_fleshtostone_06", name: "Flesh to Stone", level: 6, school: "Transmutation",
    castingTime: "1 action", range: "60 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
  ...
  "spell_floatingdisk_01": {
    id: "spell_floatingdisk_01", name: "Floating Disk", level: 1, school: "Conjuration",
    ...
    actionCost: "action", classes: ['Ritual Caster', 'Wizard']
  },
  "spell_fly_03": {
  ...
  "spell_forcecage_07": {
    id: "spell_forcecage_07", name: "Forcecage", level: 7, school: "Evocation",
    ...
    actionCost: "action", classes: ['Bard', 'Warlock', 'Wizard']
  },
  "spell_foresight_09": {
    id: "spell_foresight_09", name: "Foresight", level: 9, school: "Divination",
    ...
    actionCost: "special", classes: ['Bard', 'Druid', 'Warlock', 'Wizard']
  },
  "spell_freedomofmovement_04": {
    id: "spell_freedomofmovement_04", name: "Freedom of Movement", level: 4, school: "Abjuration",
  ...
  "spell_freezingsphere_06": {
    id: "spell_freezingsphere_06", name: "Freezing Sphere", level: 6, school: "Evocation",
    ...
    damageType: "cold",
    damage: "10d6 Cold", actionCost: "action", classes: ['Wizard']
  },
  "spell_gaseousform_03": {
    id: "spell_gaseousform_03", name: "Gaseous Form", level: 3, school: "Transmutation",
    castingTime: "1 action", range: "Touch", components: "V, S, M", duration: "Concentration, Up to 1 hour",
  ...
  "spell_gate_09": {
    id: "spell_gate_09", name: "Gate", level: 9, school: "Conjuration",
    castingTime: "1 action", range: "60 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    ...
    actionCost: "action", classes: ['Cleric', 'Sorcerer', 'Wizard']
  },
  "spell_geas_05": {
    id: "spell_geas_05", name: "Geas", level: 5, school: "Enchantment",
    castingTime: "1 minute", range: "60 feet", components: "V", duration: "30 days",
    description: `You place a magical command on a creature that you can see within range, forcing it to carry out some service or refrain from some action or course of activity as you decide. If the creature can understand you, it must succeed on a wisdom saving throw or become charmed by you for the duration. While the creature is charmed by you, it takes 5d10 psychic damage each time it acts in a manner directly counter to your instructions, but no more than once each day. A creature that can't understand you is unaffected by the spell. You can issue any command you choose, short of an activity that would result in certain death. Should you issue a suicidal command, the spell ends. You can end the spell early by using an action to dismiss it. A remove curse, greater restoration, or wish spell also ends it. Higher Levels: When you cast this spell using a spell slot of 7th or 8th level, the duration is 1 year. When you cast this spell using a spell slot of 9th level, the spell lasts until it is ended by one of the spells mentioned above.`,
    damageType: "psychic",
    damage: "5d10 Psychic", actionCost: "special", classes: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Wizard']
  },
  "spell_gentlerepose_02": {
    id: "spell_gentlerepose_02", name: "Gentle Repose", level: 2, school: "Necromancy",
    ...
    actionCost: "action", classes: ['Cleric', 'Ritual Caster', 'Wizard']
  },
  "spell_giantinsect_04": {
    id: "spell_giantinsect_04", name: "Giant Insect", level: 4, school: "Transmutation",
  ...
  "spell_glibness_08": {
    id: "spell_glibness_08", name: "Glibness", level: 8, school: "Transmutation",
  ...
  "spell_grease_01": {
    id: "spell_grease_01", name: "Grease", level: 1, school: "Conjuration",
  ...
  "spell_greaterinvisibility_04": {
    id: "spell_greaterinvisibility_04", name: "Greater Invisibility", level: 4, school: "Illusion",
    castingTime: "1 action", range: "Touch", components: "V, S", duration: "Concentration, Up to 1 minute",
    ...
    actionCost: "action", classes: ['Bard', 'Druid', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_greaterrestoration_05": {
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid']
  },
  "spell_guardianoffaith_04": {
    id: "spell_guardianoffaith_04", name: "Guardian of Faith", level: 4, school: "Conjuration",
    ...
    actionCost: "action", classes: ['Cleric']
  },
  "spell_guardsandwards_06": {
    id: "spell_guardsandwards_06", name: "Guards and Wards", level: 6, school: "Abjuration",
    castingTime: "10 minutes", range: "Touch", components: "V, S, M", duration: "24 hours",
    ...
    actionCost: "special", classes: ['Bard', 'Wizard']
  },
  "spell_guidance_00": {
  ...
  "spell_gustofwind_02": {
    id: "spell_gustofwind_02", name: "Gust of Wind", level: 2, school: "Evocation",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    ...
    actionCost: "action", classes: ['Cleric', 'Druid', 'Sorcerer', 'Wizard']
  },
  "spell_hallow_05": {
    id: "spell_hallow_05", name: "Hallow", level: 5, school: "Evocation",
    ...
    actionCost: "special", classes: ['Cleric', 'Warlock']
  },
  "spell_hallucinatoryterrain_04": {
    id: "spell_hallucinatoryterrain_04", name: "Hallucinatory Terrain", level: 4, school: "Illusion",
  ...
  "spell_harm_06": {
    id: "spell_harm_06", name: "Harm", level: 6, school: "Necromancy",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Instantaneous",
    ...
    damageType: "necrotic",
    damage: "14d6 Necrotic", actionCost: "action", classes: ['Cleric']
  },
  "spell_haste_03": {
    ...
    actionCost: "action", classes: ['Druid', 'Paladin', 'Sorcerer', 'Wizard']
  },
  "spell_heal_06": {
    id: "spell_heal_06", name: "Heal", level: 6, school: "Evocation",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Instantaneous",
    description: `Choose a creature that you can see within range. A surge of positive energy washes through the creature, causing it to regain 70 hit points. This spell also ends blindness, deafness, and any diseases affecting the target. This spell has no effect on constructs or undead. Higher Levels: When you cast this spell using a spell slot of 7th level or higher, the amount of healing increases by 10 for each slot level above 6th.`,
    actionCost: "action", classes: ['Cleric', 'Druid']
  },
  "spell_healingword_01": {
    ...
    actionCost: "bonus_action", classes: ['Bard', 'Cleric', 'Druid']
  },
  "spell_heatmetal_02": {
    id: "spell_heatmetal_02", name: "Heat Metal", level: 2, school: "Transmutation",
    castingTime: "1 action", range: "60 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    ...
    damageType: "fire",
    damage: "2d8 Fire", actionCost: "action", classes: ['Bard', 'Druid']
  },
  "spell_hellishrebuke_01": {
    id: "spell_hellishrebuke_01", name: "Hellish Rebuke", level: 1, school: "Evocation",
    castingTime: "1 reaction, which you take in response to being damaged by a creature within 60 feet of you that you can see", range: "60 feet", components: "V, S", duration: "Instantaneous",
    description: `You point your finger, and the creature that damaged you is momentarily surrounded by hellish flames. The creature must make a Dexterity saving throw. It takes 2d10 fire damage on a failed save, or half as much damage on a successful one. Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d10 for each slot level above 1st.`,
    damageType: "fire",
    damage: "2d10 Fire", actionCost: "reaction", classes: ['Paladin', 'Warlock']
  },
  "spell_heroesfeast_06": {
    id: "spell_heroesfeast_06", name: "Heroes' Feast", level: 6, school: "Conjuration",
    ...
    actionCost: "special", classes: ['Cleric', 'Druid']
  },
  "spell_heroism_01": {
    id: "spell_heroism_01", name: "Heroism", level: 1, school: "Enchantment",
    castingTime: "1 action", range: "Touch", components: "V, S", duration: "Concentration, Up to 1 minute",
    ...
    actionCost: "action", classes: ['Bard', 'Paladin']
  },
  "spell_hideouslaughter_01": {
    id: "spell_hideouslaughter_01", name: "Hideous Laughter", level: 1, school: "Enchantment",
    castingTime: "1 action", range: "30 feet", components: "V, S, M", duration: "Concentration, Up to 1 minute",
  ...
  "spell_holyaura_08": {
    id: "spell_holyaura_08", name: "Holy Aura", level: 8, school: "Abjuration",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 1 minute",
    description: `Divine light washes out from you and coalesces in a soft radiance in a 30-foot radius around you. Creatures of your choice in that radius when you cast this spell shed dim light in a 5-foot radius and have advantage on all saving throws, and other creatures have disadvantage on attack rolls against them until the spell ends. In addition, when a fiend or an undead hits an affected creature with a melee attack, the aura flashes with brilliant light. The attacker must succeed on a constitution saving throw or be blinded until the spell ends.`,
    actionCost: "action", classes: ['Cleric']
  },
  "spell_huntersmark_01": {
    id: "spell_huntersmark_01", name: "Hunter's Mark", level: 1, school: "Divination",
    castingTime: "1 bonus action", range: "90 feet", components: "V", duration: "Concentration, Up to 1 hour",
    description: `You choose a creature you can see within range and mystically mark it as your quarry. Until the spell ends, you deal an extra 1d6 damage to the target whenever you hit it with a weapon attack, and you have advantage on any Wisdom (Perception) or Wisdom (Survival) check you make to find it. If the target drops to 0 hit points before this spell ends, you can use a bonus action on a subsequent turn of yours to mark a new creature. Higher Levels:  When you cast this spell using a spell slot of 3rd or 4th level, you can maintain your concentration on the spell for up to 8 hours. When you use a spell slot of 5th level or higher, you can maintain your concentration on the spell for up to 24 hours.`,
    actionCost: "bonus_action", classes: ['Paladin', 'Ranger']
  },
  "spell_hypnoticpattern_03": {
    id: "spell_hypnoticpattern_03", name: "Hypnotic Pattern", level: 3, school: "Illusion",
  ...
  "spell_icestorm_04": {
    id: "spell_icestorm_04", name: "Ice Storm", level: 4, school: "Evocation",
    castingTime: "1 action", range: "300 feet", components: "V, S, M", duration: "Instantaneous",
    description: `A hail of rock-hard ice pounds to the ground in a 20-foot-radius, 40-foot-high cylinder centered on a point within range. Each creature in the cylinder must make a dexterity saving throw. A creature takes 2d8 bludgeoning damage and 4d6 cold damage on a failed save, or half as much damage on a successful one. Hailstones turn the storm's area of effect into difficult terrain until the end of your next turn. Higher Levels: When you cast this spell using a spell slot of 5th level or higher, the bludgeoning damage increases by 1d8 for each slot level above 4th.`,
    damageType: "bludgeoning",
    damage: "2d8 Bludgeoning", actionCost: "action", classes: ['Cleric', 'Druid', 'Paladin', 'Sorcerer', 'Wizard']
  },
  "spell_identify_01": {
    id: "spell_identify_01", name: "Identify", level: 1, school: "Divination",
    ...
    actionCost: "special", classes: ['Bard', 'Cleric', 'Ritual Caster', 'Wizard']
  },
  "spell_illusoryscript_01": {
    id: "spell_illusoryscript_01", name: "Illusory Script", level: 1, school: "Illusion",
    ...
    actionCost: "special", classes: ['Bard', 'Ritual Caster', 'Warlock', 'Wizard']
  },
  "spell_imprisonment_09": {
    id: "spell_imprisonment_09", name: "Imprisonment", level: 9, school: "Abjuration",
    ...
    actionCost: "special", classes: ['Warlock', 'Wizard']
  },
  "spell_incendiarycloud_08": {
    id: "spell_incendiarycloud_08", name: "Incendiary Cloud", level: 8, school: "Conjuration",
    ...
    damageType: "fire",
    damage: "10d8 Fire", actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_inflictwounds_01": {
    id: "spell_inflictwounds_01", name: "Inflict Wounds", level: 1, school: "Necromancy",
    castingTime: "1 action", range: "Touch", components: "V, S", duration: "Instantaneous",
    description: `Make a melee spell attack against a creature you can reach. On a hit, the target takes 3d10 necrotic damage. Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d10 for each slot level above 1st.`,
    damageType: "necrotic",
    damage: "3d10 Necrotic", actionCost: "action", classes: ['Cleric']
  },
  "spell_insectplague_05": {
    id: "spell_insectplague_05", name: "Insect Plague", level: 5, school: "Conjuration",
    castingTime: "1 action", range: "300 feet", components: "V, S, M", duration: "Concentration, Up to 10 minutes",
    description: `Swarming, biting locusts fill a 20-foot-radius sphere centered on a point you choose within range. The sphere spreads around corners. The sphere remains for the duration, and its area is lightly obscured. The sphere's area is difficult terrain. When the area appears, each creature in it must make a constitution saving throw. A creature takes 4d10 piercing damage on a failed save, or half as much damage on a successful one. A creature must also make this saving throw when it enters the spell's area for the first time on a turn or ends its turn there. Higher Levels: When you cast this spell using a spell slot of 6th level or higher, the damage increases by 1d10 for each slot level above 5th.`,
    damageType: "piercing",
    damage: "4d10 Piercing", actionCost: "action", classes: ['Cleric', 'Druid', 'Sorcerer']
  },
  "spell_instantsummons_06": {
    id: "spell_instantsummons_06", name: "Instant Summons", level: 6, school: "Conjuration",
    ...
    actionCost: "special", classes: ['Ritual Caster', 'Wizard']
  },
  "spell_invisibility_02": {
    id: "spell_invisibility_02", name: "Invisibility", level: 2, school: "Illusion",
    castingTime: "1 action", range: "Touch", components: "V, S, M", duration: "Concentration, Up to 1 hour",
    description: `A creature you touch becomes invisible until the spell ends. Anything the target is wearing or carrying is invisible as long as it is on the target's person. The spell ends for a target that attacks or casts a spell. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.`,
    actionCost: "action", classes: ['Bard', 'Druid', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_irresistibledance_06": {
    id: "spell_irresistibledance_06", name: "Irresistible Dance", level: 6, school: "Enchantment",
    ...
    actionCost: "action", classes: ['Bard', 'Wizard']
  },
  "spell_jump_01": {
    id: "spell_jump_01", name: "Jump", level: 1, school: "Transmutation",
  ...
  "spell_knock_02": {
    id: "spell_knock_02", name: "Knock", level: 2, school: "Transmutation",
  ...
  "spell_legendlore_05": {
    id: "spell_legendlore_05", name: "Legend Lore", level: 5, school: "Divination",
  ...
  "spell_lesserrestoration_02": {
    id: "spell_lesserrestoration_02", name: "Lesser Restoration", level: 2, school: "Abjuration",
    castingTime: "1 action", range: "Touch", components: "V, S", duration: "Instantaneous",
    description: `You touch a creature and can end either one disease or one condition afflicting it. The condition can be blinded, deafened, paralyzed, or poisoned.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger']
  },
  "spell_levitate_02": {
    id: "spell_levitate_02", name: "Levitate", level: 2, school: "Transmutation",
  ...
  "spell_light_00": {
    id: "spell_light_00", name: "Light", level: 0, school: "Evocation",
  ...
  "spell_lightningbolt_03": {
    id: "spell_lightningbolt_03", name: "Lightning Bolt", level: 3, school: "Evocation",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Instantaneous",
    ...
    damageType: "lightning",
    damage: "8d6 Lightning", actionCost: "action", classes: ['Druid', 'Sorcerer', 'Wizard']
  },
  "spell_locateanimalsorplants_02": {
    id: "spell_locateanimalsorplants_02", name: "Locate Animals or Plants", level: 2, school: "Divination",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Instantaneous",
  ...
  "spell_locatecreature_04": {
    id: "spell_locatecreature_04", name: "Locate Creature", level: 4, school: "Divination",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 1 hour",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger', 'Wizard']
  },
  "spell_locateobject_02": {
    id: "spell_locateobject_02", name: "Locate Object", level: 2, school: "Divination",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 10 minutes",
  ...
  "spell_longstrider_01": {
    id: "spell_longstrider_01", name: "Longstrider", level: 1, school: "Transmutation",
    castingTime: "1 action", range: "Touch", components: "V, S, M", duration: "1 hour",
    description: `You touch a creature. The target's speed increases by 10 feet until the spell ends. Higher Levels: When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each spell slot above 1st.`,
    actionCost: "action", classes: ['Bard', 'Druid', 'Ranger', 'Wizard']
  },
  "spell_magearmor_01": {
  ...
  "spell_magiccircle_03": {
    id: "spell_magiccircle_03", name: "Magic Circle", level: 3, school: "Abjuration",
    castingTime: "1 minute", range: "10 feet", components: "V, S, M", duration: "1 hour",
    description: `You create a 10-­--foot-­--radius, 20-­--foot-­--tall cylinder of magical energy centered on a point on the ground that you can see within range. Glowing runes appear wherever the cylinder intersects with the floor or other surface. Choose one or more of the following types of creatures: celestials, elementals, fey, fiends, or undead. The circle affects a creature of the chosen type in the following ways:  - The creature can't willingly enter the cylinder by nonmagical means. If the creature tries to use teleportation or interplanar travel to do so, it must first succeed on a charisma saving throw.  - The creature has disadvantage on attack rolls against targets within the cylinder.  - Targets within the cylinder can't be charmed, frightened, or possessed by the creature. When you cast this spell, you can elect to cause its magic to operate in the reverse direction, preventing a creature of the specified type from leaving the cylinder and protecting targets outside it. Higher Levels: When you cast this spell using a spell slot of 4th level or higher, the duration increases by 1 hour for each slot level above 3rd.`,
    actionCost: "special", classes: ['Cleric', 'Paladin', 'Warlock', 'Wizard']
  },
  "spell_magicjar_06": {
    id: "spell_magicjar_06", name: "Magic Jar", level: 6, school: "Necromancy",
  ...
  "spell_magicmouth_02": {
    id: "spell_magicmouth_02", name: "Magic Mouth", level: 2, school: "Illusion",
    castingTime: "1 minute", range: "30 feet", components: "V, S, M", duration: "Until dispelled",
    ...
    actionCost: "special", classes: ['Bard', 'Ritual Caster', 'Wizard']
  },
  "spell_magicweapon_02": {
    id: "spell_magicweapon_02", name: "Magic Weapon", level: 2, school: "Transmutation",
    castingTime: "1 bonus action", range: "Touch", components: "V, S", duration: "Concentration, Up to 1 hour",
    description: `You touch a nonmagical weapon. Until the spell ends, that weapon becomes a magic weapon with a +1 bonus to attack rolls and damage rolls. Higher Levels: When you cast this spell using a spell slot of 4th level or higher, the bonus increases to +2. When you use a spell slot of 6th level or higher, the bonus increases to +3.`,
    actionCost: "bonus_action", classes: ['Cleric', 'Paladin', 'Wizard']
  },
  "spell_magnificentmansion_07": {
    id: "spell_magnificentmansion_07", name: "Magnificent Mansion", level: 7, school: "Conjuration",
  ...
  "spell_majorimage_03": {
    id: "spell_majorimage_03", name: "Major Image", level: 3, school: "Illusion",
  ...
  "spell_masscurewounds_05": {
    id: "spell_masscurewounds_05", name: "Mass Cure Wounds", level: 5, school: "Conjuration",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Instantaneous",
    description: `A wave of healing energy washes out from a point of your choice within range. Choose up to six creatures in a 30-foot-radius sphere centered on that point. Each target regains hit points equal to 3d8 + your spellcasting ability modifier. This spell has no effect on undead or constructs. Higher Levels: When you cast this spell using a spell slot of 6th level or higher, the healing increases by 1d8 for each slot level above 5th.`,
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid']
  },
  "spell_massheal_09": {
    id: "spell_massheal_09", name: "Mass Heal", level: 9, school: "Conjuration",
    castingTime: "1 action", range: "60 feet", components: "V, S", duration: "Instantaneous",
    description: `A flood of healing energy flows from you into injured creatures around you. You restore up to 700 hit points, divided as you choose among any number of creatures that you can see within range. Creatures healed by this spell are also cured of all diseases and any effect making them blinded or deafened. This spell has no effect on undead or constructs.`,
    actionCost: "action", classes: ['Cleric']
  },
  "spell_masshealingword_03": {
    id: "spell_masshealingword_03", name: "Mass Healing Word", level: 3, school: "Evocation",
    castingTime: "1 bonus action", range: "60 feet", components: "V", duration: "Instantaneous",
  ...
  "spell_masssuggestion_06": {
    id: "spell_masssuggestion_06", name: "Mass Suggestion", level: 6, school: "Enchantment",
    castingTime: "1 action", range: "60 feet", components: "V, M", duration: "24 hours",
    description: `You suggest a course of activity (limited to a sentence or two) and magically influence up to twelve creatures of your choice that you can see within range and that can hear and understand you. Creatures that can't be charmed are immune to this effect. The suggestion must be worded in such a manner as to make the course of action sound reasonable. Asking the creature to stab itself, throw itself onto a spear, immolate itself, or do some other obviously harmful act automatically negates the effect of the spell. Each target must make a wisdom saving throw. On a failed save, it pursues the course of action you described to the best of its ability. The suggested course of action can continue for the entire duration. If the suggested activity can be completed in a shorter time, the spell ends when the subject finishes what it was asked to do. You can also specify conditions that will trigger a special activity during the duration. For example, you might suggest that a group of soldiers give all their money to the first beggar they meet. If the condition isn't met before the spell ends, the activity isn't performed. If you or any of your companions damage a creature affected by this spell, the spell ends for that creature. Higher Levels: When you cast this spell using a 7th-level spell slot, the duration is 10 days. When you use an 8th-level spell slot, the duration is 30 days. When you use a 9th-level spell slot, the duration is a year and a day.`,
    actionCost: "action", classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_maze_08": {
    id: "spell_maze_08", name: "Maze", level: 8, school: "Conjuration",
  ...
  "spell_meldintostone_03": {
    id: "spell_meldintostone_03", name: "Meld into Stone", level: 3, school: "Transmutation",
    castingTime: "1 action", range: "Touch", components: "V, S", duration: "8 hours",
    ...
    damageType: "bludgeoning",
    damage: "6d6 Bludgeoning", actionCost: "action", classes: ['Cleric', 'Druid', 'Ritual Caster']
  },
  "spell_mending_00": {
    id: "spell_mending_00", name: "Mending", level: 0, school: "Transmutation",
    castingTime: "1 minute", range: "Touch", components: "V, S, M", duration: "Instantaneous",
    ...
    actionCost: "special", classes: ['Cleric', 'Bard', 'Druid', 'Sorcerer', 'Wizard']
  },
  "spell_message_00": {
    id: "spell_message_00", name: "Message", level: 0, school: "Transmutation",
  ...
  "spell_meteorswarm_09": {
    id: "spell_meteorswarm_09", name: "Meteor Swarm", level: 9, school: "Evocation",
    ...
    damageType: "fire",
    damage: "20d6 Fire", actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_mindblank_08": {
    id: "spell_mindblank_08", name: "Mind Blank", level: 8, school: "Abjuration",
  ...
  "spell_minorillusion_00": {
    id: "spell_minorillusion_00", name: "Minor Illusion", level: 0, school: "Illusion",
  ...
  "spell_miragearcane_07": {
    id: "spell_miragearcane_07", name: "Mirage Arcane", level: 7, school: "Illusion",
    ...
    actionCost: "special", classes: ['Bard', 'Druid', 'Wizard']
  },
  "spell_mirrorimage_02": {
    id: "spell_mirrorimage_02", name: "Mirror Image", level: 2, school: "Illusion",
    castingTime: "1 action", range: "Self", components: "V, S", duration: "1 minute",
    ...
    actionCost: "action", classes: ['Cleric', 'Druid', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_mislead_05": {
    id: "spell_mislead_05", name: "Mislead", level: 5, school: "Illusion",
  ...
  "spell_nondetection_03": {
    id: "spell_nondetection_03", name: "Nondetection", level: 3, school: "Abjuration",
    castingTime: "1 action", range: "Touch", components: "V, S, M", duration: "8 hours",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Ranger', 'Wizard']
  },
  "spell_passwithouttrace_02": {
    id: "spell_passwithouttrace_02", name: "Pass without Trace", level: 2, school: "Abjuration",
    castingTime: "1 action", range: "Self", components: "V, S, M", duration: "Concentration, Up to 1 hour",
  ...
  "spell_passwall_05": {
    id: "spell_passwall_05", name: "Passwall", level: 5, school: "Transmutation",
    castingTime: "1 action", range: "30 feet", components: "V, S, M", duration: "1 hour",
    ...
    actionCost: "action", classes: ['Druid', 'Wizard']
  },
  "spell_phantasmalkiller_04": {
    id: "spell_phantasmalkiller_04", name: "Phantasmal Killer", level: 4, school: "Illusion",
    castingTime: "1 action", range: "120 feet", components: "V, S", duration: "Concentration, Up to 1 minute",
    description: `You tap into the nightmares of a creature you can see within range and create an illusory manifestation of its deepest fears, visible only to that creature. The target must make a wisdom saving throw. On a failed save, the target becomes frightened for the duration. At the start of each of the target's turns before the spell ends, the target must succeed on a wisdom saving throw or take 4d10 psychic damage. On a successful save, the spell ends. Higher Levels: When you cast this spell using a spell slot of 5th level or higher, the damage increases by 1d10 for each slot level above 4th.`,
    damageType: "psychic",
    damage: "4d10 Psychic", actionCost: "action", classes: ['Wizard']
  },
  "spell_phantomsteed_03": {
    id: "spell_phantomsteed_03", name: "Phantom Steed", level: 3, school: "Illusion",
  ...
  "spell_planarally_06": {
    id: "spell_planarally_06", name: "Planar Ally", level: 6, school: "Conjuration",
  ...
  "spell_planarbinding_05": {
    id: "spell_planarbinding_05", name: "Planar Binding", level: 5, school: "Abjuration",
    castingTime: "1 hour", range: "60 feet", components: "V, S, M", duration: "24 hours",
    description: `With this spell, you attempt to bind a celestial, an elemental, a fey, or a fiend to your service. The creature must be within range for the entire casting of the spell. (Typically, the creature is first summoned into the center of an inverted magic circle in order to keep it trapped while this spell is cast.) At the completion of the casting, the target must make a charisma saving throw. On a failed save, it is bound to serve you for the duration. If the creature was summoned or created by another spell, that spell's duration is extended to match the duration of this spell. A bound creature must follow your instructions to the best of its ability. You might command the creature to accompany you on an adventure, to guard a location, or to deliver a message. The creature obeys the letter of your instructions, but if the creature is hostile to you, it strives to twist your words to achieve its own objectives. If the creature carries out your instructions completely before the spell ends, it travels to you to report this fact if you are on the same plane of existence. If you are on a different plane of existence, it returns to the place where you bound it and remains there until the spell ends. Higher Levels: When you cast this spell using a spell slot of a higher level, the duration increases to 10 days with a 6th-level slot, to 30 days with a 7th-level slot, to 180 days with an 8th-level slot, and to a year and a day with a 9th-level spell slot.`,
    actionCost: "special", classes: ['Bard', 'Cleric', 'Druid', 'Wizard']
  },
  "spell_planeshift_07": {
    id: "spell_planeshift_07", name: "Plane Shift", level: 7, school: "Conjuration",
    castingTime: "1 action", range: "Touch", components: "V, S, M", duration: "Instantaneous",
  ...
  "spell_plantgrowth_03": {
    id: "spell_plantgrowth_03", name: "Plant Growth", level: 3, school: "Transmutation",
    castingTime: "1 action", range: "150 feet", components: "V, S", duration: "Instantaneous",
    ...
    actionCost: "action", classes: ['Bard', 'Cleric', 'Druid', 'Paladin', 'Ranger', 'Warlock']
  },
  "spell_poisonspray_00": {
    id: "spell_poisonspray_00", name: "Poison Spray", level: 0, school: "Conjuration",
    castingTime: "1 action", range: "10 feet", components: "V, S", duration: "Instantaneous",
    description: `You extend your hand toward a creature you can see within range and project a puff of noxious gas from your palm. The creature must succeed on a Constitution saving throw or take 1d12 poison damage. Higher Levels: This spell's damage increases by 1d12 when you reach 5th level (2d12), 11th level (3d12), and 17th level (4d12).`,
    damageType: "poison",
    damage: "1d12 Poison", actionCost: "action", classes: ['Druid', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_polymorph_04": {
  ...
  "spell_powerwordkill_09": {
    id: "spell_powerwordkill_09", name: "Power Word Kill", level: 9, school: "Enchantment",
    castingTime: "1 action", range: "60 feet", components: "V", duration: "Instantaneous",
  ...
  "spell_powerwordstun_08": {
    id: "spell_powerwordstun_08", name: "Power Word Stun", level: 8, school: "Enchantment",
    castingTime: "1 action", range: "60 feet", components: "V", duration: "Instantaneous",
    description: `You speak a word of power that can overwhelm the mind of one creature you can see within range, leaving it dumbfounded. If the target has 150 hit points or fewer, it is stunned. Otherwise, the spell has no effect. The stunned target must make a constitution saving throw at the end of each of its turns. On a successful save, this stunning effect ends.`,
    actionCost: "action", classes: ['Bard', 'Sorcerer', 'Warlock', 'Wizard']
  },
  "spell_prayerofhealing_02": {
    id: "spell_prayerofhealing_02", name: "Prayer of Healing", level: 2, school: "Evocation",
    castingTime: "10 minutes", range: "30 feet", components: "V", duration: "Instantaneous",
    description: `Up to six creatures of your choice that you can see within range each regain hit points equal to 2d8 + your spellcasting ability modifier. This spell has no effect on undead or constructs. Higher Levels: When you cast this spell using a spell slot of 3rd level or higher, the healing increases by 1d8 for each slot level above 2nd.`,
    actionCost: "special", classes: ['Cleric']
  },
  "spell_prestidigitation_00": {
    id: "spell_prestidigitation_00", name: "Prestidigitation", level: 0, school: "Transmutation",
    castingTime: "1 action", range: "10 feet", components: "V, S", duration: "1 hour",
  ...
  "spell_prismaticspray_07": {
    id: "spell_prismaticspray_07", name: "Prismatic Spray", level: 7, school: "Evocation",
    castingTime: "1 action", range: "Self", components: "V, S", duration: "Instantaneous",
    ...
    damageType: "fire",
    damage: "10d6 Fire", actionCost: "action", classes: ['Sorcerer', 'Wizard']
  },
  "spell_prismaticwall_09": {
    id: "spell_prismaticwall_09", name: "Prismatic Wall", level: 9, school: "Abjuration",
    ...
    damageType: "fire",
    damage: "10d6 Fire", actionCost: "action", classes: ['Wizard']
  },
};
